...
- @timvir/blocks/ColorBar <span style={{ opacity: 0.5 }}>(esm)</span>
- @timvir/blocks/Exhibit <span style={{ opacity: 0.5 }}>(esm)</span>
- @timvir/blocks/Grid <span style={{ opacity: 0.5 }}>(esm)</span>
- @timvir/blocks/Message <span style={{ opacity: 0.5 }}>(esm)</span>
...
- @timvir/blocks/Code
  - Code
- @timvir/blocks/ColorBar
  - ColorBar
- @timvir/blocks/Exhibit
  - Exhibit
- @timvir/blocks/Grid
  - Grid
- @timvir/blocks/Message
  - Message
