...
import { extendedWidth } from "../../Page";
...
If you have more than about six background colors, make the component a bit wider, or even full-width.

<Sample variant="extended" className={extendedWidth} />
