...
<Grid>
  <Exhibit caption="info" style={{ gridColumn: "initial" }}>
    <Sample variant="basic" props={{ variant: "info" }} />
  </Exhibit>
  <Exhibit caption="warning" style={{ gridColumn: "initial" }}>
    <Sample variant="basic" props={{ variant: "warning" }} />
  </Exhibit>
  <Exhibit caption="alert" style={{ gridColumn: "initial" }}>
...
<Grid>
<Exhibit caption="Inline title" style={{ gridColumn: "initial" }}>
  <Sample variant="basic">
...
<Exhibit caption="Title as a separate block elment" style={{ gridColumn: "initial" }}>
  <Sample variant="basic">
