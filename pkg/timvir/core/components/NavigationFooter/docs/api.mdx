...
<Props {...{"fields":[{"name":"Link","type":{"optional":false,"name":"typeof Link","module":""},"comment":{"shortText":""}},{"name":"prev","type":{"optional":true,"name":"{ href: string; label: ReactNode; context: ReactNode; }","module":""},"comment":{"shortText":""}},{"name":"next","type":{"optional":true,"name":"{ href: string; label: ReactNode; context: ReactNode; }","module":""},"comment":{"shortText":""}}]}} />
