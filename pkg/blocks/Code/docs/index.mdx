...
The `<Code>` component provides syntax highlighting for code blocks. The code can be for example <Sample variant="toggle" language="javascript">JavaScript</Sample>, <Sample variant="toggle" language="markdown">Markdown</Sample>, <Sample variant="toggle" language="html">HTML</Sample>, or <Sample variant="toggle" language="haskell">Haskell</Sample>.

<Code id="code-1" language="tsx" highlightedLines={[2, 7]} caption="The highlighted lines show how to import and use the <Code> block.">
...
<Code language="javascript" caption="The Hitchhiker's Guide to the Galaxy">const answer = 42;</Code>
